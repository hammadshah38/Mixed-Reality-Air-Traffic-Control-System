...
namespace HoloLensHandTracking
{
    ...
    public class HandsTrackingController : MonoBehaviour
    {
        ...
        private void InteractionManager_InteractionSourceDetected(InteractionSourceDetectedEventArgs args)
        {
            ...
            {
                Vector3 updatedPos = new Vector3(pos.x, pos.y, pos.z + 0.75f);
                obj.transform.position = updatedPos;
                StatusText.text = "x:" + updatedPos.x + ",y:" + updatedPos.y + ",z:" + updatedPos.z;
            }
        ...
        private void InteractionManager_InteractionSourceUpdated(InteractionSourceUpdatedEventArgs args)
        {
            ...
            if (args.state.source.kind == InteractionSourceKind.Hand)
            {
                if (trackingObject.ContainsKey(id))
                {
                    ...
                    {
                        Vector3 updatedPos = new Vector3(pos.x, pos.y, pos.z + 0.75f);
                        trackingObject[id].transform.position = updatedPos;
                        StatusText.text = "x:" + updatedPos.x + ",y:" + updatedPos.y + ",z:" + updatedPos.z;
                    }
